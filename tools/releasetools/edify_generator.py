...
class EdifyGenerator(object):
  ...
  def PrintPadrePioUIBanner(self, android_version, build_id, build_date,
                                  security_patch, device):
    self.Print("----------------------------------------------")
    self.Print("                PadrePioUI")
    self.Print("         by developers devoted to God")
    self.Print("----------------------------------------------")
    ...
    self.Print(" Device about to be blessed: %s"%(device))
    self.Print("----------------------------------------------")
    self.Print("     Prepare to feel the Power of God.")
    self.Print("----------------------------------------------")
